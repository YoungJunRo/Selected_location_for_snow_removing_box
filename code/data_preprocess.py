...
#급경사지 (warnway)
warnway = pd.read_csv('../data/org/행정안전부_급경사지 현황_20211231.csv', encoding='cp949')
...
##org
people=pd.read_csv('../data/LOCAL_PEOPLE_GU_2021.csv',encoding='euc-kr')
